...
export const Popover = ({ children, content }) => {
    ...
    return (
        <div className="relative inline-block" onMouseEnter={togglePopover} onMouseLeave={togglePopover}>
            {children}
            {isPopoverOpen && (
                <div className="absolute left-[-18rem] top-1/2 transform -translate-y-1/2 z-10 w-64 text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm dark:text-gray-400 dark:border-gray-600 dark:bg-gray-800">
                    <div className="px-3 py-2 bg-gray-100 border-b border-gray-200 rounded-t-lg dark:border-gray-600 dark:bg-gray-700">
                        <h3 className="font-semibold text-gray-900 dark:text-white">Lecturer Details</h3>
                    </div>
