            ...
            <div className="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 dark:bg-gray-800">
                ...
                {isConfirmed && (
                    <section className="mt-6">
                        ...
                        <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-200">Final Submission</h3>
                        <br/>
                        ...
                        <br/>
                        <div className="mt-4">
                        <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-200">General Submissions</h3>
                            {assignments.length > 0 ? (
                                <Timeline 
                                    tasks={assignments.map((assignment) => {
                                        const dueDateTimestamp = assignment.AssignmentDueDate?.seconds * 1000;
