                ...
                <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800 bg-[linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url('../../src/assets/images/sidebar-bg-6.jpg')] bg-cover bg-center bg-no-repeat">
                    ...
                    <ul className="space-y-2 font-medium">
                        <li>
                            <a
                                href="/dashboard"
                                className={`flex items-center p-2 rounded-lg group ${location.pathname === "/dashboard"
                        ...
                        <li>
                            <a
                                href="/analytics"
                                className={`flex items-center p-2 rounded-lg group ${location.pathname === "/analytics"
                                        ? "bg-gray-100 text-gray-900 dark:bg-gray-700 dark:text-white"
                                        : "text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                                    }`}
                            >
                        ...
                        <li style={{ display: "none" }} >
                            <a
                                href="/reports"
                                className={`flex items-center p-2 rounded-lg group ${location.pathname === "/reports"
                                        ? "bg-gray-100 text-gray-900 dark:bg-gray-700 dark:text-white"
                                        : "text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                                    }`}
                            >
                        ...
                        <li>
                            <a
                                href="/settings"
                                className={`flex items-center p-2 rounded-lg group ${location.pathname === "/settings"
                                        ? "bg-gray-100 text-gray-900 dark:bg-gray-700 dark:text-white"
                                        : "text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                                    }`}
                            >
                        ...
                        <li>
                            <a
                                href="/logout"
                                className={`flex items-center p-2 rounded-lg group ${location.pathname === "/logout"
                                        ? "bg-gray-100 text-gray-900 dark:bg-gray-700 dark:text-white"
                                        : "text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                                    }`}
                            >
                ...
                <div className="absolute bottom-6 left-4 right-4 bg-white dark:bg-gray-900 rounded-lg shadow-md p-5">
                    <div className="flex items-center space-x-3">
                        ...
                        <div className="text-sm">
                            <p className="text-gray-900 font-bold dark:text-gray-300">{departmentName}</p>
