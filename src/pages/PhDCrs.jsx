...
import BannerImg from '../assets/images/RegImage5.jpg';
...
export const PhDCrs = () => {
    ...
    const fetchAssignmentData = async () => {
        const cachedAssignments = localStorage.getItem('phdAssignments');
        if (cachedAssignments) {
            ...
            localStorage.setItem('phdAssignments', JSON.stringify(courseTypesArray)); // Cache data
        }
    };
        ...
        <div className="p-4 sm:ml-6 sm:mr-6 lg:ml-72 lg:mr-72">
            <div className="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 dark:bg-gray-800">
                ...
                <section className="mt-6" style={{display: "none"}}>
                    <h2 className="text-3xl font-extrabold text-gray-800 dark:text-gray-200">PhD Research</h2>
                    <p className="text-gray-700 mt-2 text-lg font-semibold dark:text-gray-400">
                        {/* Header for supervisor PhD research */}
                        Here are all the assignments you have posted.
                    </p>
                </section>

                <section className="mb-6 border-2 border-[#590098] rounded-lg p-4">
                    <h3 className="text-xl font-bold text-[#590098]">Research Milestones</h3>
                ...
                <section className="mt-6 border-2 border-[#00bfff] rounded-lg p-4">
                    <h2 className="text-xl font-bold text-[#00bfff] dark:text-gray-200">Research Topics</h2>
