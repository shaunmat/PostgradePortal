    ...
    return (
        <div className="p-4 sm:ml-64 pt-16">
            <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
                ...
                <div className="grid grid-cols-1 gap-4 mb-4">
                    <div className="flex flex-col rounded-xl bg-white dark:bg-gray-800">
                        <div className="flex items-center justify-between w-full px-4 py-2">
                            <h2 className="text-xl font-extrabold text-gray-800 dark:text-gray-200">Student and Supervisor Overview for 2024 </h2>
                        </div>
                ...
                <div className="flex flex-col rounded-xl bg-white dark:bg-gray-800" style={{margin:'100px'}}>
                    {/* Header */}
                    <div className="flex items-center justify-between w-full px-6 py-4">
                        <h1 className="text-3xl font-extrabold text-gray-800 dark:text-gray-200">Supervisors Details <span className="text-[#FF8503] dark:text-[#FF8503]">2024</span></h1>
